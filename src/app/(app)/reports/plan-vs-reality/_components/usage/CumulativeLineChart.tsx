...
export default function CumulativeLineChart({ data, planTotal, height = 220 }: Props) {
  if (!data.length) {
    ...
    <div style={{ height }} className="w-full">
      <svg viewBox={`0 0 ${w} ${h}`} className="w-full h-full">
        ...
        <line
          ...
          strokeDasharray="6 6"
        />
        <text x={padL + innerW - 2} y={Math.max(padT + 12, yPlan - 6)} textAnchor="end" fontSize="11" fill="currentColor" opacity="0.6">
