...
import { VIEWS, type ViewKey } from "./_components/metrics.types";
    ...
    >
      {view === "project" ? (
        ...
        <div className="card p-4">
          <div className="flex items-start justify-between gap-3">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Ten moduł jest osadzony w shellu, backend + UI dojdą później.
              </p>
            </div>
          ...
          <div className="mt-4 h-40 rounded-xl border border-border bg-background/30" />
        </div>
      )}
    </MetricsLayout>
  );
